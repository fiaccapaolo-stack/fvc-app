...
async function main() {
  ...
  // lasciando invariato il resto della configurazione. Non invia notifiche:
  // per avvisare i clienti si usa il pulsante "Invia notifica" a parte,
  // quando hai finito tutte le modifiche.
  ...
  // Invio manuale: da usare quando hai finito di aggiornare catalogo,
  // offerte e informazioni negozio, e vuoi avvisare tutti i clienti in una
  // volta sola.
